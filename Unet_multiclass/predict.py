...
if __name__ == "__main__":
    ...
    org_image = Image.open("./DATA/DENEME/images/2007_000783.jpg")
    ...
    model.load_state_dict(torch.load("./model_sil.pth"))
    model.eval()
    ...
    with torch.no_grad():
        ...
        print(image.shape)
        output = model(image)  # (1,3,1024,1024), 3 is number of classes
